            ...
            <span className="text-slate-400 text-[10px]">•{periodoTexto} </span>
             ...
             {onSincronizar && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-lg bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-400 hover:text-emerald-300 border border-emerald-500/30 text-[9px] font-medium transition active:scale-85 disabled:opacity-50 shadow-sm"
              >

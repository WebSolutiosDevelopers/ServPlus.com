      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
        ...
        <div>
          <div className="justify-between  w-full flex items-center gap-2 text-slate-400 text-xs font-semibold uppercase tracking-wider mb-1">
            ...
            <span className="text-[11px] justify-center">Resumo de Faturamento</span>
            <span className="text-slate-400 text-[10px]">•{periodoTexto} </span>
             ...
             {onSincronizar && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-1 py-1.0 rounded-lg bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-400 hover:text-emerald-300 border border-emerald-500/30 text-[9px] font-medium transition active:scale-85 disabled:opacity-50 shadow-sm"
              >

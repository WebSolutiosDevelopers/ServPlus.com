...
import { isInstalacao, isMudancaEndereco, normalizeText } from '../utils/servicoUtils';
...
export const ServicoFormModal: React.FC<ServicoFormModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Cálculo do valor: R$ 100 por Instalação ou Mudança de Endereço
      const isRemunerado = isInstalacao({ tipoServico, tipoAtividade }) || isMudancaEndereco({ tipoServico, tipoAtividade });
      const valorServico = isRemunerado ? 100 : 0;
